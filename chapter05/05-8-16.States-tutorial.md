...
第四部分：如何使用salt的[file_roots](https://docs.saltstack.com/en/latest/ref/configuration/master.html#std:conf_master-file_roots)来设置一个工作流，在该工作流中，状态可以从开发、QA到生产依次“升级”。
